...
namespace cagd
{
    GLdouble CyclicCurves3::_CalculateNormalizingCoefficient(GLuint n)
    {
        if (!n)
        {
            return 1.0;
    ...
    GLvoid CyclicCurves3::_CalculateBinomialCoefficients(GLuint m, TriangularMatrix<GLdouble> &bc)
    {
        bc.ResizeRows(m + 1);
        bc(0, 0) = 1.0;
    ...
    CyclicCurves3::CyclicCurves3(GLuint n, GLenum data_usage_flag):
    ...
    GLboolean CyclicCurves3::BlendingFunctionValues(GLdouble u, RowMatrix<GLdouble> &values) const
    {
    ...
    GLboolean CyclicCurves3::CalculateDerivatives(GLuint max_order_of_derivatives, GLdouble u, Derivatives &d) const
    {
